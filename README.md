...
1. Copy the example file:
   ...
   (On macOS/Linux: `cp appsettings.Development.json.example appsettings.Development.json`)

2. Edit `appsettings.Development.json` with your SQL Server connection string and a strong random JWT key (at least 32 characters).

`appsettings.Development.json` is listed in `.gitignore` and will not be pushed.
